...
-- SQL Test Suite, V6.0, Interactive SQL, dml175.sql
-- 59-byte ID
-- TEd Version #
...
-- TEST:0887 FIPS sizing, NCHAR ( 500)!

   CREATE TABLE CONTACTS (
     NAME CHAR (20),
     DESCRIPTION NCHAR (500),
     KEYWORDS NCHAR (500));
-- PASS:0887 If table created successfully?
...
-- PASS:0887 If table dropped successfully?

   COMMIT WORK;

-- END TEST >>> 0887 <<< END TEST
-- *********************************************
-- *************************************************////END-OF-MODULE
