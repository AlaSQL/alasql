-- MODULE MPB003R  repetition

-- SQL Test Suite, V6.0, Interactive SQL, mpb003r.sql
-- 59-byte ID
-- TEd Version #
...
-- Repeat 1 more time for each ROLLBACK needed
     ...
     UPDATE TT SET DOLLARS = DOLLARS + 10 WHERE ANUM = 50;

     UPDATE TT SET DOLLARS = DOLLARS - 10 WHERE ANUM = 25;
