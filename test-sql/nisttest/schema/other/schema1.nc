-- SQL Test Suite, V6.0, Schema Definition, schema1.nc
-- 59-byte ID
-- TEd Version #
-- date_time print
-- ***************************************************************
...
-- and which require "create unique index" syntax to implement uniqueness
-- can still execute the remaining tests.
  ...
  CREATE UNIQUE INDEX STAFF_IND ON STAFF(EMPNUM);
  ...
  CREATE UNIQUE INDEX PROJ_IND ON PROJ(PNUM);
  ...
  CREATE UNIQUE INDEX WORKS_IND ON WORKS(EMPNUM,PNUM);
  ...
  CREATE UNIQUE INDEX PROJ1_IND ON PROJ1(PNUM);
  ...
  CREATE UNIQUE INDEX UPINDEX ON UPUNIQ(NUMKEY);
...
-- The following tables are used to test the limitations (12-14-88)
  ...
  CREATE UNIQUE INDEX T8_IND ON T8(COL1,COL2,COL3,COL4,COL5,COL6);

  CREATE TABLE T118(STR118 CHAR(118) NOT NULL);

  CREATE UNIQUE INDEX T118_IND ON T118 (STR118);
  ...
  CREATE TABLE WHICH_SCHEMA1 (C1 CHAR (1));
...
-- ************* grant statements follow *************
   ...
   GRANT ALL PRIVILEGES ON TESTREPORT
   ...
   GRANT ALL PRIVILEGES ON P15 TO FLATER;

   GRANT ALL PRIVILEGES ON T100 TO FLATER;

   GRANT ALL PRIVILEGES ON TOKENS TO PUBLIC;
