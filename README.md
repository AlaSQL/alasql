...
or you can use aexec() - promised version of exec (in this case you need to install [es6-promise module](https://www.npmjs.org/package/es6-promise) for Node.js) (this feature is experimental and may be removed):
```
