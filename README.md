# Alasql.js - pure JavaScript client-side in-memory fast SQL database with NoSQL functionality

Version: 0.0.26 Date: November 26, 2014 [Change log](CHANGELOG.md), [Release plan](RELEASES.md)
