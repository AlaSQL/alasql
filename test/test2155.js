...
describe('Test 2155 - ROUND should return undefined for null input', function () {
	test('ROUND(null) should return undefined per AlaSQL NULL definition', function (done) {
	...
	test('ROUND("123.4") should return 123', function (done) {
	...
	test('ROUND("abc") should return undefined', function (done) {
	...
	test('ROUND("") should return undefined', function (done) {
	...
	test('ROUND("0") should return 0', function (done) {
	...
	test('ROUND("null") should return undefined', function (done) {
	...
	test('ROUND("00") should return 0', function (done) {
	...
	test('ROUND("0.0") should return 0', function (done) {
	...
	test('SUM(ROUND(null)) should return undefined when all values are null', function (done) {
	...
	test('ROUND with mix of null and numbers', function (done) {
	...
	test('ROUND(string) should return undefined', function (done) {
	...
	test('SUM(ROUND(string)) should return undefined when all values are strings', function (done) {
