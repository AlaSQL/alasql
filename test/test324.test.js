...
describe('Test 324 Roads samples', function () {
	...
	test.skip('2. OBJECT_ID()', function (done) {
	...
	test.skip('3. CREATE TABLE with constraints', function (done) {
  ...
  */
	...
	test.skip('4. INSERT INTO table with constraints', function (done) {
		var res = alasql(function () {
			/*
  ...
  */
	...
	test.skip('5. INSERT INTO table with same primary key', function (done) {
	...
	test.skip('6. INSERT INTO wrong NULL in NOT NULL column', function (done) {
		assert.throws(function () {
			var res = alasql(function () {
				/*
		INSERT INTO dbo.Employees(empid, mgrid, empname, salary) VALUES
	...
	test.skip('7. UPDATE wrong NULL in NOT NULL column', function (done) {
		assert.throws(function () {
	...
	test.skip('8. UPDATE wrong NULL in NOT NULL column', function (done) {
		var res = alasql('UPDATE dbo.Employees SET mgrid = NULL WHERE empid = 2');
		assert(res == 1);
		done();
	});

	test.skip('9. UPDATE wrong NULL in NOT NULL column', function (done) {
		assert.throws(function () {
	...
	test.skip('10. INSERT INTO table with constraints violation', function (done) {
	...
	test.skip('11. INSERT INTO table with constraints violation', function (done) {
		//    console.log(alasql.databases.dbo.tables.Employees);
		var res = alasql(
			"INSERT INTO dbo.Employees(empid, mgrid, empname, salary) \
	...
	test.skip('12. UPDATE wrong NULL in NOT NULL column', function (done) {
		var res = alasql('UPDATE dbo.Employees SET mgrid = 3 WHERE empid = 2');
		assert(res == 1);
		done();
	});

	test.skip('13. UPDATE table with constraints violation', function (done) {
		//    console.log(alasql.databases.dbo.tables.Employees);
		assert.throws(function () {
	...
	test.skip('14. CURRENT_TIMESTAMP', function (done) {
	...
	test.skip('20. Full example', function (done) {
