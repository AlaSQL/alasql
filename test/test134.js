...
describe('Test 134 SELECT FROM', function () {
	if (false) {
		test('1. Load data from CSV and TAB', function (done) {
		...
		test('2. INSERT (Node.js only)', function (done) {
		...
		test('3. EXCEL LOAD (require load sheet.xls libraries', function (done) {
		...
		test('4. EXCEL SAVE', function (done) {
			if (typeof window === 'object') {
