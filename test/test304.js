...
describe('Test 304 SEARCH over JSON', function() {
  ...
  it('1. INSTANCEOF selector',function(done){
  ...
  it('2. CLASS() selector',function(done){
  ...
  it('3. PLUS selector',function(done){
  ...
  it('4. STAR and QUESTION selector',function(done){
  ...
  it('5. STAR and QUESTION selectors in GRAPHS',function(done){
  ...
  it('6. STAR and QUESTION selectors in GRAPHS',function(done){
    var res = alasql('SEARCH / "Olga" (>>)+ name');
