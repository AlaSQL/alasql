...
describe.skip(
	'Test ' + testId + ' Load data from text file with default headers option',
	function () {
		beforeAll(function () {
		...
		test('2. Load CSV with {headers:true}', function (done) {
			alasql(
		...
		test('3. Load CSV by default', function (done) {
		...
		test('4. Load CSV with {headers:false}', function (done) {
			alasql(
		...
		test('4. Load XLSX with {headers:true}', function (done) {
			alasql(
		...
		test('5. Load XLSX', function (done) {
		...
		test('6. Load XLSX with {headers:true}', function (done) {
			alasql(
