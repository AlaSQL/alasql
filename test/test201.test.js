...
describe('Test 201 SUM(DISTINCT), VAR(), STDDEV()', () => {
	test('1. different SUM()s', done => {
	...
	test('1a. different COUNT()s', done => {
		var data = [{a: 1}, {a: 1}, {a: 2}, {a: 3}];
	...
	test('2. SUM() vs SUM(DISTINCT a)', done => {
		var data = [{a: 1}, {a: 1}, {a: 2}, {a: 3}];
