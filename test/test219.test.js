...
describe('Test 219 CREATE VIEW', function () {
	test('1. CREATE VIEW SYNTAX', function (done) {
		alasql(
	...
	test('2. RUN FROM VIEW', function (done) {
		var res = alasql('SELECT * FROM myview');
		//    	console.log(res);
		assert.deepEqual(res, [{a: 1}, {a: 2}, {a: 3}]);
		done();
	});
	test('3. RUN FROM JOIN VIEW', function (done) {
	...
	test('4. CHANGE DATA IN VIEW', function (done) {
	...
	test('5. DROP VIEW', function (done) {
