...
describe('Test 371 INSERT OR REPLACE', function() {
     ...
     it('2. Test INSERT',function(done){
        ...
        assert.deepEqual(res,[ { a: 4, b: 'Four' }, { a: 5, b: 'Five' }, { a: 1, b: 'Ein' } ]);
     ...
     it('3. Test INSERT OR REPLACE',function(done){
        ...
        var res = alasql('SELECT * FROM one');
        assert.deepEqual(res,[ { a: 1, b: 'Uno' }, { a: 2, b: 'Two' }, { a: 3, b: 'Three' } ]);
...
//        assert(res == 1);
        ...
        assert.deepEqual(res,[ { a: 1, b: 'Ein' }, { a: 2, b: 'Two' }, { a: 3, b: 'Three' }, 
        { a: 4, b: 'Four' }, { a: 5, b: 'Five' } ]);
