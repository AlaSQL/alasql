...
describe('Test 337 SEARCH 8 queens', function() {
  ...
  it('2. SEARCH RANGE',function(done){
...
//console.log(res);
  ...
  it('5. SEARCH WHERE ',function(done){
    var res = alasql(function(){/*
  ...
  it('6. SEARCH AS and RETURN ',function(done){
    var res = alasql(function(){/*
...
//    console.log(res);
  ...
  it('9. SEARCH SET variable',function(done){
    alasql.vars.b = [];
    var res = alasql(function(){/*
...
//    console.log(res);
  ...
  it('10. SEARCH REPEAT',function(done){
    alasql.vars.b = [];
    var res = alasql(function(){/*
...
//    console.log(res);
  ...
  it('11. SEARCH REPEAT',function(done){
    alasql.vars.b = [];
    var res = alasql(function(){/*
...
//    console.log(res);
  ...
  it('12. SEARCH REPEAT',function(done){
    alasql.vars.b = [];
    var res = alasql(function(){/*
...
//    console.log(res);
  ...
  it('13. SEARCH REPEAT',function(done){
    alasql.vars.b = [];
    var res = alasql(function(){/*
...
//    console.log(res);
  ...
  it('14. SEARCH REPEAT',function(done){
    alasql.vars.b = [];
    var res = alasql(function(){/*
...
//    console.log(res);
  ...
  it('15. SEARCH REPEAT with index',function(done){
    alasql.vars.b = [];
    var res = alasql(function(){/*
...
//    console.log(res);
  ...
  it('16. SEARCH REPEAT with index',function(done){
    alasql.vars.b = [];
    alasql.vars.a = [1,2];
    var res = alasql(function(){/*
...
if(false) {
  it('17. SEARCH REPEAT with index',function(done){
    alasql.vars.b = [];
    var res = alasql(function(){/*
  ...
  it('90. SEARCH 8 queens',function(done){
