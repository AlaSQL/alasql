...
describe('Test 308 sub SEARCH', function() {
  ...
  it('3. SUM and other aggregators',function(done){
  ...
  it('4. SUM with nested selector',function(done){
  ...
  it('5. Complex SUM with tree selector',function(done){
...
//    console.log(res);
  ...
  it('10. SUM over graph',function(done){
  ...
  it('11. SUM over graph',function(done){
