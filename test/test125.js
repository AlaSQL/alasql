...
//		alasql('-- my comments \n\r create table two (b int)');
		...
		alasql('insert into one values (1,1,1), (2,2,2), /* (0,0,0), (1,2,3), -- */ (4,4,4), (5,5,5), (6,6,6)');
		alasql('insert into two values (1),(2),(3),(6)');

		var res = alasql('select one.a q, two.b AS w from one join two /* one on a=b*/ using b -- dddkjslkjas alksdj akj af;sdkj a');
