...
describe('Test '+test+' - SQL added user defined aggregation', function() {
	...
	*/
	var sumPlusRows='function(a,b,c){if(1==c){var d=a+1;return d}return 2==c?b=b+a+1:3==c?b:void 0};';
	...
	*/
	...
	var sumMinusRows = 'function(a,b,c){if(1==c){var d=a-1;return d}return 2==c?b=b+a-1:3==c?b:void 0};';
	
	it.skip('A) Sync AGGREGATOR', function(){
		var res = alasql('CREATE AGGREGATOR abc_A AS ``'+sumPlusRows+'``;select value abc_A(a) FROM @[{a:10},{a:100}]; CREATE AGGREGATOR abc_A AS ``'+sumMinusRows+'``;select value abc_A(a) FROM @[{a:10},{a:100}]')
	...
	it.skip('C) Sync AGGREGATE', function(){
		var res = alasql('CREATE AGGREGATE abc_C AS ``'+sumPlusRows+'``;select value abc_C(a) FROM @[{a:10},{a:100}]; CREATE AGGREGATE abc_C AS ``'+sumMinusRows+'``;select value abc_C(a) FROM @[{a:10},{a:100}]')
