...
describe('Test 05 - DELETE', function () {
	it('DELETE WHERE ', function (done) {
		...
		var sql2 =
			"INSERT INTO schools (schoolid, schoolname) VALUES (1,'Northern Pacific School')";
		var sql3 =
			"INSERT INTO schools (schoolid, schoolname) VALUES (2,'Western Atlantic School')";
		var sql4 =
			"INSERT INTO schools (schoolid, schoolname) VALUES (3,'East Arctic School')";
		var sql5 =
			"INSERT INTO schools (schoolid, schoolname) VALUES (4,'South Indian School')";
