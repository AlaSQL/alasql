...
describe('Test 897 - CASCADE not supported (sqlite)', function () {
	...
	it('19: Should parse REFERENCES with all referential actions', function () {
		...
		alasql('CREATE TABLE test_child18a (id INT PRIMARY KEY, parent_id INT REFERENCES test_parent18(id) ON DELETE CASCADE)');
		alasql('CREATE TABLE test_child18b (id INT PRIMARY KEY, parent_id INT REFERENCES test_parent18(id) ON DELETE SET NULL)');
		alasql('CREATE TABLE test_child18c (id INT PRIMARY KEY, parent_id INT REFERENCES test_parent18(id) ON DELETE SET DEFAULT)');
		alasql('CREATE TABLE test_child18d (id INT PRIMARY KEY, parent_id INT REFERENCES test_parent18(id) ON DELETE RESTRICT)');
		alasql('CREATE TABLE test_child18e (id INT PRIMARY KEY, parent_id INT REFERENCES test_parent18(id) ON DELETE NO ACTION)');
