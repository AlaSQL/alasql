...
describe('Test ' + test + ' - SHOW COLUMNS and SHOW INDEX with qualified table names', function () {
	it('1. Setup test databases and tables', function (done) {
	...
	it('2. SHOW COLUMNS with unqualified name (USE context)', function () {
		alasql('USE test2200a');
	...
	it('3. SHOW COLUMNS with qualified name (database.table)', function () {
	...
	it('4. SHOW INDEX with unqualified name (USE context)', function () {
		alasql('USE test2200a');
	...
	it('5. SHOW INDEX with qualified name (database.table)', function () {
		// This test should work regardless of current USE context
		alasql('USE test2200b');
	...
	it('6. SHOW COLUMNS with qualified name in different database', function () {
		alasql('USE test2200a');
	...
	it('7. SHOW INDEX with qualified name in different database', function () {
		alasql('USE test2200a');
	...
	it('8. Cleanup test databases', function (done) {
