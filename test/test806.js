...
describe('Test ' + test + ' - INSERT statement to string has parenthesis around values.', function() {
	it('Insert\'s toString() returns values within parenthesis', function() {
        ...
        var expectedToStringValue2 = 'INSERT INTO cities VALUES (\'Rome\',2863223),(\'Paris\',2249975),(\'Berlin\',3517424),(\'Madrid\',3041579)';
