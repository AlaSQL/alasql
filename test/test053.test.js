...
describe('Test 53 - Automatic types parsing', function () {
	describe('Primitive types', function () {
		...
		test('Date type... Not yet realized', function (done) {
			var ast = alasql.parse('SELECT DATE("2014-10-12")');
			done();
		});

		test('Arifmetic operations', function (done) {
		...
		test('String operations', function (done) {
		...
		test('Logic operations', function (done) {
		...
		test('Logic operations on numbers', function (done) {
		...
		test('Logic operations on strings', function (done) {
		...
		test('Logic operations on BETWEEN', function (done) {
			var ast = alasql.parse(
		...
		test('Logic operations on IN', function (done) {
		...
		test('Logic operations on ALL and SOME', function (done) {
		...
		test('Logic operations on EXISTS', function (done) {
		...
		test('Aggregators on SUM, COUNT, AVG', function (done) {
		...
		test('Aggregators FIRST, LAST, MIN, MAX on numbers', function (done) {
		...
		test('Aggregators FIRST, LAST, MIN, MAX on strings', function (done) {
		...
		if (false) {
			test('Columns from tables', function (done) {
			...
			test('Columns from subqueries', function (done) {
