...
describe('Test 123 - SHOW DATABASES, TABLES, COLUMNS, INDEX, CREATE TABLE', function () {
	test('1. SHOW DATABASES', function (done) {
	...
	test('2. SHOW TABLES', function (done) {
	...
	test('3. SHOW COLUMNS', function (done) {
	...
	test('4. SHOW CREATE TABLE', function (done) {
	...
	if (false) {
		test('5. SHOW INDEX', function (done) {
