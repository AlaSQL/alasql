...
yy.Select.prototype.compileJoins = function (query) {
	...
	this.joins.forEach(function (jn) {
		...
		if (jn.table) {
			...
			/*/*
		var jnparam = jn.param.param;
		source.datafn = new sandboxedFunction('query,params,cb,idx',
...
*/
			...
			source.datafn = new sandboxedFunction('query, params, cb, idx, alasql', s);
...
*/
		...
		if (jn.using) {
			...
			source.onleftfn = new sandboxedFunction('p,params,alasql', 'var y;return ' + source.onleftfns);
			...
			source.onrightfns = jn.using
				...
				.join('+"`"+');
			source.onrightfn = new sandboxedFunction('p,params,alasql', 'var y;return ' + source.onrightfns);
		...
		// 	source.onleftfn = new sandboxedFunction('p', 'return '+source.onleftfns);
		// 	source.onrightfns = jn.on.right.toJS('p',query.defaultTableid);
		// 	source.onrightfn = new sandboxedFunction('p', 'return '+source.onrightfns);
*/
				var lefts = '';
				var rights = '';
				var middles = '';
				...
				source.onleftfn = new sandboxedFunction('p,params,alasql', 'var y;return ' + source.onleftfns);
				source.onrightfn = new sandboxedFunction('p,params,alasql', 'var y;return ' + source.onrightfns);
				source.onmiddlefn = new sandboxedFunction('p,params,alasql', 'var y;return ' + source.onmiddlefns);
				...
				source.onmiddlefn = new sandboxedFunction(
					'p,params,alasql',
