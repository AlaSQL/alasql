...
*/
		...
		var insertfn = new sandboxed_function('db, params, alasql', 'var y;' + s3 + s).bind(this);
		...
		if (db.engineid && alasql.engines[db.engineid].intoTable) {
			...
			var defaultfn = new sandboxed_function('r,db,params,alasql', defaultfns);
		...
		var insertfn = new sandboxed_function('db,params,alasql', insertfns);
	} else {
	...
	if (db.engineid && alasql.engines[db.engineid].intoTable && alasql.options.autocommit) {
		var statement = function (params, cb) {
			var aa = new sandboxed_function('db,params', 'var y;' + s33 + 'return aa;')(db, params);
			//			console.log(s33);
