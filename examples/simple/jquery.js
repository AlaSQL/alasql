...
(function (e, undefined) {
	...
	(x.fn = x.prototype = {
		...
		init: function (e, t, n) {
			...
			return e.nodeType
				...
				: x.isFunction(e)
				? n.ready(e)
				: (e.selector !== undefined && ((this.selector = e.selector), (this.context = e.context)),
				  x.makeArray(e, this));
		},
		selector: '',
		length: 0,
		...
		x.extend({
			...
			makeArray: function (e, t) {
				var n = t || [];
				return (
					null != e && (j(Object(e)) ? x.merge(n, 'string' == typeof e ? [e] : e) : h.call(n, e)), n
				);
			},
			...
			return (
				n ||
					...
					'complete' === o.readyState
						? setTimeout(x.ready)
						: (o.addEventListener('DOMContentLoaded', S, !1), e.addEventListener('load', S, !1))),
				n.promise(t)
			);
		}),
					...
					return t !== p && 9 === t.nodeType && t.documentElement
						? ((p = t),
						  ...
						  (n.getById = ut(function (e) {
								return (
									(f.appendChild(e).id = v), !t.getElementsByName || !t.getElementsByName(v).length
								);
						  })),
						  n.getById
						  ...
						  (S = f.compareDocumentPosition
								? function (e, r) {
										...
										return i
											? 1 & i || (!n.sortDetached && r.compareDocumentPosition(e) === i)
												? e === t || y(b, e)
													? -1
													: r === t || y(b, r)
													? 1
					...
					if ((n = i.relative[e[l].type])) f = [yt(vt(f), n)];
						...
						if (((n = i.filter[e[l].type].apply(null, e[l].matches)), n[v])) {
							...
							return bt(
								l > 1 && vt(f),
								l > 1 &&
									mt(e.slice(0, l - 1).concat({value: ' ' === e[l - 2].type ? '*' : ''})).replace(
										z,
										'$1'
									),
								n,
			...
			function kt(e, t, r, o) {
				...
				if (!o && 1 === f.length) {
					...
					while (s--) {
						...
						if (
							(p = i.find[c]) &&
							(o = p(l.matches[0].replace(nt, rt), (U.test(u[0].type) && t.parentNode) || t))
						) {
			...
			c = {
				...
				fireWith: function (e, t) {
					return (
						!a ||
							(n && !u) ||
							((t = t || []), (t = [e, t.slice ? t.slice() : t]), r ? u.push(t) : l(t)),
						this
					);
				},
				fire: function () {
				  ...
				  x(function () {
						...
						a &&
							...
							e.getComputedStyle &&
								...
								(t.boxSizingReliable =
									'4px' === (e.getComputedStyle(i, null) || {width: '4px'}).width),
		...
		(F.prototype = {
			...
			access: function (e, t, n) {
				...
				return t === undefined || (t && 'string' == typeof t && n === undefined)
					? ((r = this.get(e, t)), r !== undefined ? r : this.get(e, x.camelCase(t)))
			...
			remove: function (e, t) {
				...
				if (t === undefined) this.cache[o] = {};
					...
					x.isArray(t)
						...
						: ((i = x.camelCase(t)),
						  t in s ? (r = [t, i]) : ((r = i), (r = r in s ? [r] : r.match(w) || []))),
						(n = r.length);
			...
			if (u)
				for (t = (e || '').match(w) || []; a > s; s++)
					if (
						((n = this[s]),
						(r =
							1 === n.nodeType && (n.className ? (' ' + n.className + ' ').replace(W, ' ') : ' ')))
					) {
						o = 0;
				...
				if (i)
					return (
						...
						t && 'get' in t && (n = t.get(i, 'value')) !== undefined
							? n
							: ((n = i.value), 'string' == typeof n ? n.replace($, '') : null == n ? '' : n)
					);
			}
		},
	}),
	...
	(x.event = {
				...
				while (c--)
					(u = X.exec(t[c]) || []),
						...
						d &&
							...
							f.add && (f.add.call(e, p), p.handler.guid || (p.handler.guid = n.guid)),
		...
		special: {
			...
			click: {
				trigger: function () {
					return 'checkbox' === this.type && this.click && x.nodeName(this, 'input')
						? (this.click(), !1)
						: undefined;
				},
				_default: function (e) {
				...
				? (e && e.type
						? ((this.originalEvent = e),
						  ...
						  (this.isDefaultPrevented =
								e.defaultPrevented || (e.getPreventDefault && e.getPreventDefault()) ? U : Y))
						: (this.type = e),
				  t && x.extend(this, t),
						...
						for (u = o[o.length - 1].ownerDocument, x.map(o, ht), l = 0; s > l; l++)
							(a = o[l]),
								at.test(a.type || '') &&
									...
									x.contains(u, a) &&
									(a.src ? x._evalUrl(a.src) : x.globalEval(a.textContent.replace(lt, '')));
				}
				return this;
			},
		}),
				...
				r.style &&
					...
					t
						? (o[s] || 'none' !== n || (r.style.display = ''),
						  '' === r.style.display && Lt(r) && (o[s] = q.access(r, 'olddisplay', Rt(r.nodeName))))
						: o[s] ||
						  ((i = Lt(r)),
					...
					return (
						...
						n === undefined
							...
							: ((o = typeof n),
							  'string' === o &&
									(i = kt.exec(n)) &&
									((n = (i[1] + 1) * i[2] + parseFloat(x.css(e, t))), (o = 'number')),
							  null == n ||
									('number' === o && isNaN(n)) ||
			...
			'margin' === n && (s += x.css(e, n + jt[o], !0, i)),
				r
					? ('content' === n && (s -= x.css(e, 'padding' + jt[o], !0, i)),
					  'margin' !== n && (s -= x.css(e, 'border' + jt[o] + 'Width', !0, i)))
		...
		x.cssHooks[t] = {
			...
			set: function (e, n, r) {
				...
				return Ot(
					...
					n,
					r
						? Ft(e, t, r, x.support.boxSizing && 'border-box' === x.css(e, 'boxSizing', !1, i), i)
						: 0
				);
			},
		};
		...
		x.extend({
			...
			ajax: function (e, t) {
				...
				(u = c.global),
					...
					(r = c.url),
					c.hasContent ||
						(c.data && ((r = c.url += (Vt.test(r) ? '&' : '?') + c.data), delete c.data),
						c.cache === !1 &&
							(c.url = Jt.test(r)
								? r.replace(Jt, '$1_=' + Yt++)
								: r + (Vt.test(r) ? '&' : '?') + '_=' + Yt++)),
					...
					T.setRequestHeader(
						...
						c.dataTypes[0] && c.accepts[c.dataTypes[0]]
							? c.accepts[c.dataTypes[0]] + ('*' !== c.dataTypes[0] ? ', ' + sn + '; q=0.01' : '')
							: c.accepts['*']
					);
				...
				function k(e, t, o, a) {
					...
					2 !== v &&
						...
						d.fireWith(p, [T, C]),
						u && (f.trigger('ajaxComplete', [T, c]), --x.active || x.event.trigger('ajaxStop')));
				}
				return T;
			},
			...
			return a || 'jsonp' === t.dataTypes[0]
				? ((i = t.jsonpCallback = x.isFunction(t.jsonpCallback)
				  ...
				  a
						...
						: t.jsonp !== !1 && (t.url += (Vt.test(t.url) ? '&' : '?') + t.jsonp + '=' + i),
		...
		if (!x.isEmptyObject(c)) {
			...
			for (r in c)
				(s = Sn(f ? h[r] : 0, r, l)),
					r in h ||
						((h[r] = s.start),
						f && ((s.end = s.start), (s.start = 'width' === r || 'height' === r ? 1 : 0)));
		}
	}
