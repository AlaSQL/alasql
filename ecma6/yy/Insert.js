...
//
*/
//formerly 70insert.js
//yy.Insert
export function Insert(params) { return extend(this, params); }
...
Insert.prototype.toJS = function(context, tableid, defcols) {
...
Insert.prototype.compile = function (databaseid) {
	var self = this;
...
Insert.prototype.execute = function (databaseid, params, cb) {
