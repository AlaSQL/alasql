...
export function Delete(params) { return extend(this, params); }
...
Delete.prototype.compile = function (databaseid) {
//  console.log(11,this);
...
Delete.prototype.execute = function (databaseid, params, cb) {
