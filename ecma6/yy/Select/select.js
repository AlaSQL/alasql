...
import {AggrValue} from "../AggrValue.js";
import {escapeq,n2u} from "../../utils/strings.js";
/*
//
...
export function compileSelectStar(query,alias) {
...
export function compileSelect1(query) {
	var self = this;
	query.columns = [];
	query.xcolumns = {};
	query.selectColumns = {};
...
export function compileSelect2(query) {
...
export function compileSelectGroup0(query) {
	var self = this;
...
export function compileSelectGroup1(query) {
	var self = this;
	var s = 'var r = {};';
...
export function compileSelectGroup2(query) {
...
export function compileRemoveColumns(query) {
	var self = this;
