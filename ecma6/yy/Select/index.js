...
import {compileDefCols} from "./compileDefCols.js";
import {compileFrom} from "./compileFrom.js";
import {compileHaving} from "./compileHaving.js";
import {compileGroup} from "./compileGroup.js";
import {compileJoins} from "./compileJoins.js";
import {compileOrder} from "./compileOrder.js";
import {
	compileSelectStar,
	compileSelectGroup0,
	compileSelectGroup1,
	compileRemoveColumns,
	compileSelectGroup2,
	compileSelect1,
	compileSelect2} from "./select.js";
import {Query} from "../../global/Query.js";
import {alasql} from "../../global/alasql.js";
import {queryfn} from "../../global/queryfn.js";
//import {compilePivot} from "./compilePivot.js";
/*
//
...
export function Select(params) { return extend(this, params); }


Select.prototype.compileGroup = compileGroup,
Select.prototype.compilePivot = compilePivot,
Select.prototype.compileDefCols = compileDefCols,
Select.prototype.compileFrom = compileFrom,
Select.prototype.compileHaving = compileHaving,
Select.prototype.compileGroup = compileGroup,
Select.prototype.compileJoins = compileJoins,
Select.prototype.compileOrder = compileOrder,
Select.prototype.compileSelectStar = compileSelectStar,
Select.prototype.compileSelectGroup0 = compileSelectGroup0,
Select.prototype.compileSelectGroup1 = compileSelectGroup1,
Select.prototype.compileRemoveColumns = compileRemoveColumns,
Select.prototype.compileSelectGroup2 = compileSelectGroup2,
Select.prototype.compileSelect1 = compileSelect1,
Select.prototype.compileSelect2 = compileSelect2;
 ...
 */
Select.prototype.toJS = function(context) {
...
// };
Select.prototype.execute = function (databaseid, params, cb) {
...
Select.prototype.compileWhere = function(query) {
	if(this.where) {
...
Select.prototype.compileWhereJoins = function(query) {
	return;
...
Select.prototype.compileWhereExists = function(query) {
...
Select.prototype.compileQueries = function(query) {
...
Select.prototype.compile = function(databaseid) {
...
//console.log(this.modifier);
	...
	if(this.into) {
		...
		} else if (this.into instanceof FuncValue) {
			//
