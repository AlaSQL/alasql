...
export function Update(params) { return yy.extend(this, params); }
...
Update.prototype.compile = function (databaseid) {
//	console.log(this);
...
Update.prototype.execute = function (databaseid, params, cb) {
