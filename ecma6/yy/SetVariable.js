...
export function SetVariable(params) { return yy.extend(this, params); }
SetVariable.prototype.toString = function() {
	var s = 'SET ';
...
SetVariable.prototype.execute = function (databaseid,params,cb) {
//	console.log(this);
