...
export function SQL(filename, opts, data, columns, cb) {
	var res;
...
export function HTML(selector, opts, data, columns, cb) {
	var res = 1;
...
export function JSON(filename, opts, data, columns, cb) {
	var res = 1;
	if(typeof filename == 'object') {
		opts = filename;
		filename = undefined;
...
export function TXT(filename, opts, data, columns, cb) {
	// If columns is empty
